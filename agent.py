...
WORK_RULES = (
    ...
    "'/work/dataset.csv', '/work/profile.json', '/work/changes.json', "
...
def create_analytics_agent(backend: ModalSandbox) -> CompiledStateGraph:
    ...
    cleaner: SubAgent = {
        ...
        "system_prompt": (
            ...
            "first, then apply fixes to '/work/dataset.csv' in place and write "
            "'/work/changes.json' logging every decision made.\n\n" + WORK_RULES
        ),
        "model": model,
    ...
    analyst: SubAgent = {
        ...
        "system_prompt": (
            ...
            "Read '/work/dataset.csv' and '/work/changes.json', then produce "
